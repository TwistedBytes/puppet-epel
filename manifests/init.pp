...
class epel (
  ...
  $epel_testing_priority                  = $epel::params::epel_testing_priority,
  ...
  $epel_source_priority                   = $epel::params::epel_source_priority,
  ...
  $epel_debuginfo_priority                = $epel::params::epel_debuginfo_priority,
  ...
  $epel_testing_source_priority           = $epel::params::epel_testing_source_priority,
  ...
  $epel_testing_debuginfo_priority        = $epel::params::epel_testing_debuginfo_priority,
  ...
  if $facts['os']['family'] == 'RedHat' and $facts['os']['name'] != 'Fedora' {
    if $epel_testing_managed {
      yumrepo { 'epel-testing':
        ...
        priority       => $epel_testing_priority,
    ...
    if $epel_testing_debuginfo_managed {
      yumrepo { 'epel-testing-debuginfo':
        ...
        priority       => $epel_testing_debuginfo_priority,
        gpgkey         => "file:///etc/pki/rpm-gpg/RPM-GPG-KEY-EPEL-${os_maj_release}",
    ...
    if $epel_testing_source_managed {
      yumrepo { 'epel-testing-source':
        ...
        priority       => $epel_testing_source_priority,
        gpgkey         => "file:///etc/pki/rpm-gpg/RPM-GPG-KEY-EPEL-${os_maj_release}",
    ...
    if $epel_debuginfo_managed {
      yumrepo { 'epel-debuginfo':
        ...
        priority       => $epel_debuginfo_priority,
        gpgkey         => "file:///etc/pki/rpm-gpg/RPM-GPG-KEY-EPEL-${os_maj_release}",
